        ...
        <div className="bg-white rounded-lg shadow-sm border border-[var(--border-default)] p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-[var(--accent-primary)] text-[#2d3748] font-mono py-3 px-6 rounded hover:bg-[var(--accent-secondary)] focus:outline-none focus:ring-2 focus:ring-[var(--accent-primary)] focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
